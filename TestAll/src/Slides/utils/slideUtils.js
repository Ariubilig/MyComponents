...
export function createAndAnimateSlide(root, index, isScrollingForward, initMarqueeAnimation, onTransitionComplete) {
  const carousel = root;
  if (!carousel) return;
  ...
  // NOTE: marquee animation must be initialized AFTER the element is attached to DOM
  ...
  if (isScrollingForward) {
    ...
    // Now that the element is in the DOM, initialize marquee
