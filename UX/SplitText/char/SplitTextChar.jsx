...
/**
 * SplitTextChar - A reusable component that animates text by splitting it into characters
 ...
 * @param {number} props.stagger - Delay between character animations (default: 0.03)
    ...
    () => {
      ...
      elements.forEach((element) => {
        ...
        try {
          ...
          console.warn("SplitTextChar: Failed to split element", error);
        }
      });
